...
namespace MongoDB.Azure.ReplicaSets.ReplicaSetRole
{
    ...
    internal static class Settings
    {
        ...
        internal const string DataDirSizeSetting = "Two10.MongoDB.MongoDBDataDirSizeMB";
        internal const string LogDirSetting = "Two10.MongoDB.MongodLogDir";
        internal const string LogVerbositySetting = "Two10.MongoDB.MongoDBLogVerbosity";
