...
SET NR_INSTALLER_NAME=NewRelicAgent_x64_2.3.126.0.msi

REM Update with your license key
SET LICENSE_KEY=%NewRelic.LicenseKey%

SETLOCAL EnableExtensions

REM if defined NEWRELIC_HOME GOTO NR_ALREADY_INSTALLED
REM if defined COR_ENABLE_PROFILING GOTO PROFILER_ALREADY_ENABLED
if NOT exist %NR_INSTALLER_NAME% GOTO MISSING_INSTALLER

if exist timestamp.log GOTO NR_ALREADY_INSTALLED
